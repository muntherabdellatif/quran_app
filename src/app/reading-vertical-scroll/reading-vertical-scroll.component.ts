...
@Component({
  selector: 'app-reading-vertical-scroll',
  templateUrl: './reading-vertical-scroll.component.html',
  styleUrls: ['./reading-vertical-scroll.component.scss']
})
export class ReadingVerticalScrollComponent {
